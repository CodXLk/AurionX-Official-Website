...
const teamMembers = [
  ...
  },
  {
    ...
    linkedin: "https://www.linkedin.com/in/heshansanjaya/",
  ...
  },
  {
    name: "Lahiru Tissera",
    role: "Lead Developer",
    image: "/assets/images/lahiru.jpeg",
    dataAiHint: "professional sri lankan man portrait",
    initials: "LT",
...
const whyChooseUsItems = [
  {
    ...
    description:
      "Bespoke solutions tailored to your unique business requirements with no unnecessary features.",
  ...
  },
  {
    ...
    title: "Local Support",
    description:
      "Dedicated Sri Lankan team providing fast, friendly, and expert support in your time zone.",
  ...
  },
  {
    ...
    description:
      "Enterprise-grade security with robust hosting services ensuring 99.9% uptime guarantee.",
  ...
  },
  {
    ...
    description:
      "Proven methodologies and agile processes that deliver results faster than industry standards.",
...
const coreValues = [
  ...
  },
  {
    icon: ShieldCheck,
    title: "Integrity",
    description: "Honest, transparent communication in all dealings",
  },
  {
    icon: Heart,
  ...
  },
  {
    icon: Award,
    title: "Excellence",
    description: "Uncompromising quality in every line of code",
  },
];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-logo-purple via-primary/95 to-logo-purple text-primary-foreground py-20 md:py-32">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                {["6+ Years", "50+ Projects", "Sri Lankan Roots"].map(
                  (item, index) => (
                    <motion.div
                      key={item}
              ...
              >
                ...
                >
                  <Link href="/portfolio">See Our Impact</Link>
                </Button>
              </motion.div>
            </motion.div>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg
            ...
            className="w-full h-12 md:h-20 text-background"
          >
            <path
              fill="currentColor"
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                ...
                <span className="text-accent font-medium">
                  {" "}
                  intelligent, high-quality, and scalable
                </span>{" "}
                software solutions. We believe that the right technology can be
                a powerful catalyst for growth, efficiency, and innovation.
              </p>
              <p className="text-muted-foreground mb-8 leading-relaxed">
                ...
                committed to our clients' success, helping transform Sri Lankan
                ...
                <Card className="h-full text-center border-border/50 hover:border-accent/30 transition-all duration-300 hover:shadow-lg group bg-gradient-to-br from-card to-secondary/20">
                  <CardContent className="p-6">
                    <div className="flex justify-center mb-4">
                      <div
                        className={`w-16 h-16 bg-${item.color}/10 rounded-2xl flex items-center justify-center group-hover:bg-${item.color}/20 transition-colors duration-300`}
                      >
                    ...
                    <Badge
                      variant="outline"
                      className="mb-4 text-xs bg-accent/5 text-accent border-accent/20"
                    >
                      {item.highlight}
                    </Badge>
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                The passionate professionals behind AurionX's success, bringing
                years of experience and innovative thinking to every project.
              </p>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Join 50+ businesses that trust AurionX for their software
                development needs. Contact us for a free consultation and
